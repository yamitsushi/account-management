...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)('user', ['setUsername'])), {}, {
    login: function login() {
      var _this = this;

      axios.get('/sanctum/csrf-cookie').then(function (response) {
        axios.post("/login", _this.loginData).then(function (response) {
          _this.setUsername(response.data);
  ...
  mounted: function mounted() {
    ...
    axios.get("/api/check").then(function (response) {
      _this2.setUsername(response.data);
  ...
  return _c("div", { staticClass: "container" }, [
    _c("div", { staticClass: "row justify-content-center" }, [
      _c("div", { staticClass: "col-md-7 col-lg-5" }, [
        _c("div", { staticClass: "card o-hidden shadow-lg my-5 card-border" }, [
                ...
                ? _c("form", [
                    _c("div", { staticClass: "form-group" }, [
                      _c("input", {
                        ...
                        attrs: { type: "string", placeholder: "Username" },
                    ...
                    _c(
                      ...
                      {
                        staticClass:
                          "btn btn-primary btn-user btn-block btn-maroon",
                        on: {
...
var staticRenderFns = [
  function() {
    ...
    return _c("div", { staticClass: "p-0" }, [
      _c("img", {
        attrs: {
          src: "https://via.placeholder.com/500x100?text=Demo+Management",
          width: "100%"
        }
      })
    ])
...
//# sourceMappingURL=resources_js_components_pages_Login_vue.js.map